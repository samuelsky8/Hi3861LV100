...
enum cmd_tags
{
 ...
 /* STATION/DUT Commands */
    ...
    WFA_AP_SET_WIRELESS_TLV,              /* 84 */
    WFA_AP_SET_SECURITY_TLV,              /* 85 */
    WFA_AP_SET_PMF_TLV,
    WFA_AP_REBOOT_TLV,
...
enum resp_tags
{
 ...
 /* STATION/DUT Responses */
    ...
    WFA_AP_SET_WIRELESS_RESP_TLV,               /* 84 */
    WFA_AP_SET_SECURITY_RESP_TLV,               /* 85 */
    WFA_AP_SET_PMF_RESP_TLV,
    WFA_AP_REBOOT_RESP_TLV,
    WFA_AP_CONFIG_COMMIT_RESP_TLV,
    WFA_AP_RESET_DEFAULT_RESP_TLV,
    WFA_AP_GET_INFO_RESP_TLV,
    WFA_AP_DEAUTH_STA_RESP_TLV,
//    WFA_STA_SET_PWRSAVE_RESP_TLV,
//    WFA_STA_SET_SECURITY_RESP_TLV,
//    WFA_STA_SET_UAPSD_RESP_TLV,
    WFA_AP_GET_MAC_ADDRESS_RESP_TLV,
    WFA_AP_CA_VERSION_RESP_TLV,
    WFA_STA_PRESET_PARAMETERS_RESP_TLV,

    WFA_STA_RESPONSE_END
