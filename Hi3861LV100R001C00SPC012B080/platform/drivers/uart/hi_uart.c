...
hi_u32 hi_uart_lp_restore(hi_uart_idx id)
{
    ...
    /* set baudrate */
    hi_reg_write16((phys_base + UART_IBRD), g_uart_regs_save[port_num].ibrd); //lint !e644
    hi_reg_write16((phys_base + UART_FBRD), g_uart_regs_save[port_num].fbrd); //lint !e644
