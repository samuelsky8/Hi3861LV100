...
#define UART_DEFAULT_TX_USE_DMA      1
#define UART_DEFAULT_RX_USE_DMA      1
#define UART_DEFAULT_TX_BLOCK        2
#define UART_DEFAULT_RX_BLOCK        2
...
#define UART_ACT_DEFAULT     {UART_DEFAULT_TX_BUFFER_SIZE, UART_DEFAULT_RX_BUFFER_SIZE, UART_DEFAULT_TX_USE_DMA, \
                              UART_DEFAULT_RX_USE_DMA, UART_DEFAULT_TX_BLOCK, UART_DEFAULT_RX_BLOCK, 0}
