...
HI_CONST hi_flash_protect_size g_flash_protect_size_lower[] = {
    /* bit[5]:cmp
     * bit[4:0]:bp[4:0]:  见器件手册
     */
    { 0b000000, 0x0,  0 },  /* 不保护 */
    { 0b011100, 0x8,  0 },  /* 保护32KB */
    { 0b001001, 0x10, 0 }, /* 保护64KB */
    { 0b001100, 0x80, 0 }, /* 保护512KB */
    { 0b001101, 0x100, 0 }, /* 保护1024KB */
};
...
hi_u32 flash_protect_prv(hi_u32 flash_offset, hi_u32 size, hi_bool is_volatile)
{
    ...
    if (p_ctrl->run_kernel_a) {                        /* Kernel A 保护高地址 */
