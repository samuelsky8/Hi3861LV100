 ...
 *  @ingroup linux
*/
#ifndef __COMPAT_LINUX_WAIT_H__
#define __COMPAT_LINUX_WAIT_H__
...
#define add_wait_queue(qwait, qnew_wait) do{} while (0)
#define remove_wait_queue(qwait, qold_wait) do{} while (0)
#define DECLARE_WAITQUEUE(qwait, qcurrent) do{} while (0)
