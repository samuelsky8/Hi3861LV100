...
#include <linux/io.h>
#include <time.h> // 20181122 ԭ sys/time.h
#include "asm/io.h"
#include "errno.h"
#include "string.h"
#include "unistd.h"
 ...
 *
 * @par Description:
 * This API is used to delay the execution of the current task.
 * The task is able to be scheduled after it is delayed for a specified number of Ticks.
 *
 * @attention
 * <ul>
...
static inline void printtime(void)
{
    ...
    PRINTK("[time:%ld.%03ld]", time.tv_sec, time.tv_usec/1000);
    return;
}
