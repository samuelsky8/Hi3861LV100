...
#define RPL_VERSION_STRING "nStack_RPL_N100 1.0.1.SPC1.B001 "__DATE__
...
#define RPL_PRN_ADDR(log_type, str, ip6addr) do {                                                   \
  log_type("%s %02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x\n",          \
           str, (uint32_t)(ip6addr)->a8[0], (uint32_t)(ip6addr)->a8[1], (uint32_t)(ip6addr)->a8[2], \
           (uint32_t)(ip6addr)->a8[3], (uint32_t)(ip6addr)->a8[4], (uint32_t)(ip6addr)->a8[5],      \
           (uint32_t)(ip6addr)->a8[6], (uint32_t)(ip6addr)->a8[7], (uint32_t)(ip6addr)->a8[8],      \
           (uint32_t)(ip6addr)->a8[9], (uint32_t)(ip6addr)->a8[10], (uint32_t)(ip6addr)->a8[11],    \
           (uint32_t)(ip6addr)->a8[12], (uint32_t)(ip6addr)->a8[13], (uint32_t)(ip6addr)->a8[14],   \
           (uint32_t)(ip6addr)->a8[15]);                                                            \
} while (0)
...
#define PRN_LADDR(log_type, str, lladdr) do {                             \
  log_type("%s %02x:%02x:%02x:%02x:%02x:%02x:%02x:%02x\n",                \
           str, (uint32_t)(lladdr)->addr[0], (uint32_t)(lladdr)->addr[1], \
           (uint32_t)(lladdr)->addr[2], (uint32_t)(lladdr)->addr[3],      \
           (uint32_t)(lladdr)->addr[4], (uint32_t)(lladdr)->addr[5],      \
           (uint32_t)(lladdr)->addr[6], (uint32_t)(lladdr)->addr[7]);     \
} while (0)
#elif RPL_MAX_LLADDR_LEN == 6
#define PRN_LADDR(log_type, str, lladdr) do {    \
  log_type("%s %02x:%02x:%02x:%02x:%02x:%02x\n", \
           str,                                  \
           (uint32_t)(lladdr)->addr[0],          \
           (uint32_t)(lladdr)->addr[1],          \
           (uint32_t)(lladdr)->addr[2],          \
