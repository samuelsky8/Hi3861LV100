...
* @param  id        [IN] type #hi_uart_idx，UART port id. CNcomment:UART端口号。CNend
* @param  data      [IN] type #hi_u8*，Start address of the data to be read.CNcomment:读到数据的首地址。CNend
...
*
* @param  id            [IN] type #hi_uart_idx，UART port id. CNcomment:UART端口号。CNend
* @param  param         [IN] type #hi_uart_attribute*，UART base settings.CNcomment:UART基本参数。CNend
* @param  extra_attr    [IN] type #hi_uart_extra_attr*，UART extra settings. CNcomment:UART优化参数。CNend
*
* @retval #HI_ERR_SUCCESS  Success.
* @retval #HI_ERR_FAILURE  Failure.
* @par 依赖:
