...
* @attention None
* @param  id    [IN] type #hi_io_name，I/O index.CNcomment:硬件管脚。CNend
* @param  val   [IN] type #hi_io_driver_strength*，I/O drive strength level.CNcomment:IO驱动能力级别。CNend
*
* @retval #0       Success.
* @retval #Other   Failure. For details, see hi_errno.h.
* @par 依赖:
...
* @attention None
* @param  id      [IN] type #hi_io_name，I/O index.CNcomment:硬件管脚。CNend
* @param  state   [IN] type #hi_bool *，IO input enable state.CNcomment:IO的输入使能状态。CNend
*
* @retval #0       Success.
* @retval #Other   Failure. For details, see hi_errno.h.
* @par 依赖:
